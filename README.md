...
- [SmartFood_Frontend](https://github.com/TangZhiyi-1024/SmartFood_Frontend) – Frontend UI for SmartFood application (SCSS / React/Vue style).
- [Multi-point Digital Management Platform](https://github.com/TangZhiyi-1024/Multi-point_digital_management_platform) – Java-based digitized enterprise management system backend. 
